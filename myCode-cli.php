...
foreach ($global_data->emotes as $name => $emote_detail)
{
    ...
    $sql_active = true;
    $lines .= "INSERT INTO `mybb`.`mybb_mycode` (`cid`, `title`, `description`, `regex`, `replacement`, `active`, `parseorder`) VALUES (NULL, '".$sql_title."', '".mysqli_real_escape_string($link,$sql_description)."', '".$sql_regex."', '".$sql_replacement."', '1', '0');\n";
    $general_count++;
}   
